...
ARCHITECTURE behavorial OF neuron_layer_2 IS 

	SIGNAL w_0 : sfixed(3 DOWNTO -4);
	SIGNAL w_1 : sfixed(3 DOWNTO -4);
	SIGNAL latchOut : sfixed(3 DOWNTO 4);
	SIGNAL currentProduct : sfixed(8 DOWNTO 0);
	SIGNAL currentSum : sfixed(10 DOWNTO 0);
	SIGNAL sum : sfixed(10 DOWNTO 0);
